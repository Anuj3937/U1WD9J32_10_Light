    ...
    if (date && timeSlot && counselor) {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description: `Your ${sessionType} session with ${
            counselors.find((c) => c.id === counselor)?.name
          } is scheduled for ${format(date, "EEEE, MMMM d")} at ${timeSlot}.`,
        });
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Choose a counselor, date, and time that works for you
        </CardDescription>
      </CardHeader>
