      ...
      <main className="container mx-auto p-4 space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full">
          ...
          <Button className="w-full md:w-auto">
            {" "}
            {/* Ensure button fits within smaller screens */}
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-2 rounded-lg bg-red-500/10">
                    <AlertCircle className="h-5 w-5 text-red-500" />
                    <div className="flex-1">
                      <p className="text-sm font-medium">Crisis Alert</p>
                      <p className="text-xs text-muted-foreground">
                        Patient: John D. requires immediate attention
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-2 rounded-lg bg-yellow-500/10">
                    <UserCheck className="h-5 w-5 text-yellow-500" />
                    <div className="flex-1">
                      <p className="text-sm font-medium">Missed Session</p>
                      <p className="text-xs text-muted-foreground">
                        Sarah M. missed 2 consecutive sessions
                      </p>
                    </div>
