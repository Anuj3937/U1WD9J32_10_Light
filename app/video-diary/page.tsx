          ...
          <AlertDialog open={showInsights} onOpenChange={setShowInsights}>
            <AlertDialogContent className="max-w-lg">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>Here's what we've learned:</AlertDialogDescription>
              </AlertDialogHeader>
              ...
              {currentEntry.insights && (
                <>
                  {/* Sentiment */}
                  <p><strong>Sentiment:</strong> {currentEntry.insights.sentiment}</p>

                  {/* Emotional State */}
                  <p><strong>Emotional State:</strong> {currentEntry.insights.emotionalState}</p>
